        ...
        <>
            {
                nameReceiver && (
                    <div className="fixed bottom-8 right-8 z-50 animate-fadeInUp">
                        <div
                            className="w-72 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-xl shadow-2xl p-4 transform transition-all hover:scale-105">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1">
                                    <p className="text-lg font-semibold text-white">{nameReceiver} calling...</p>
