    ...
    return (
        <div className='flex flex-col border h-screen fixed left-0 top-0'>
            ...
            <ul className='text-3xl flex flex-col justify-center grow w-full'>
                ...
                <li className='h-16'>
                    <NavButton href='/message' iconClass={"fa-brands fa-facebook-messenger"}></NavButton>
                </li>
                <li className='h-16'>
                    <NavButton href='/' iconClass={"fa-solid fa-bell"}></NavButton>
                </li>
                <li className='h-16'>
                    <NavButton href='/post' iconClass={"fa-regular fa-square-plus"}></NavButton>
                </li>
            </ul>
