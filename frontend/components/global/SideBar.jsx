    ...
    return (
        ...
        >
            <div className="relative flex flex-row ">
                <div
                    className="flex flex-col border-r-1 dark:border-neutral-700 border-neutral-400 h-screen fixed left-0 top-0 z-50">
                    <UnifyLogoIcon/>
                    <NotificationModal
                ...
                />
                        ...
                        <li className="h-16 flex justify-center items-center">
                            {user && (
                                ...
                                >
                                    <div
                                        className="w-8 h-8 rounded-full border-2 dark:border-gray-300 border-black overflow-hidden">
                                        <Image
