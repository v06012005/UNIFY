...
const LoginPage = () => {
    ...
    const login = () => {
        signIn('google', {callbackUrl: 'http://localhost:3000/user-profile'}).then(r => console.log(r));
    }
            ...
            <div align={'center'}>
                <div className={`grid gap-5`}>
                    ...
                    <div className={`flex items-center gap-2 m-auto`} onClick={login}>
                        ...
                        <span className={`hover:underline cursor-pointer`}>Continue with Google ?</span>
                    </div>
