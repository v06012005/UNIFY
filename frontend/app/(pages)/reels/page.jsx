...
const Reels = () => {
  ...
  return (
    <div
      className="w-screen h-screen overflow-y-scroll scroll-snap-type-y-mandatory "
      style={{
    ...
    >
      {reels.map((_, index) => (
        <div
          key={index}
          className="relative w-[450px] h-[700px] bg-gray-800 mx-auto rounded-2xl overflow-hidden m-5 scroll-snap-align-start"
        >
