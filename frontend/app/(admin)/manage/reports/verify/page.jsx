  ...
  return (
    <div className="py-5 px-7 h-screen w-[78rem]">
      <div className="w-full flex justify-between items-center">
        <h1 className="text-2xl font-black">Verify Report Management</h1>
              ...
              {currentItems.map((report, index) => (
                <tr key={report.id} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                  ...
                  <td className="py-2 text-center flex justify-center gap-2">
                    <button className="border border-yellow-500 text-yellow-500 px-3 py-1 rounded-md hover:bg-yellow-500 hover:text-white">
                      <i className="fa-solid fa-magnifying-glass"></i>
                    </button>
                    <button className="border border-green-500 text-green-500 px-3 py-1 rounded-md hover:bg-green-500 hover:text-white">
                      Approve
                    </button>
